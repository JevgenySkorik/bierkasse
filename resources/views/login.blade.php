                ...
                <form method="POST" class="space-y-4 md:space-y-6" action="{{ route('authenticate') }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name"
                            class="bg-zinc-50 border border-zinc-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <button type="submit"
                        class="w-full text-white text-sm bg-yellow-600 hover:bg-yellow-500 text-gray-900 font-bold py-1.5 px-4 rounded">Sign
                        in</button>
                </form>
            </div>
        </div>
