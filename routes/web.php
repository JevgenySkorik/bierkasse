...
Route::middleware(LanguageMiddleware::class)->group(function () {
    Route::get('/', [JournalController::class, 'index'])->middleware(LanguageMiddleware::class)->name('index');
    Route::get('/mobile/{productID?}', [JournalController::class, 'mobile'])->name('mobile');
    Route::get('/myDebt', [AdminController::class, 'myDebt'])->name('myDebt');
    ...
    Route::get('/exportProducts', [AdminController::class, 'exportProducts'])->name('exportProducts');
    Route::get('/exportJournal', [AdminController::class, 'exportJournal'])->name('exportJournal');
